# micro-color-contrast

> Micro check wcag color contrast ratios

[![PyPI version](https://badge.fury.io/py/micro-color-contrast.svg)](https://pypi.org/project/micro-color-contrast/)
...
```bash
pip install micro-color-contrast
```
...
# Basic usage
result = contrast("your input here")
print(result)
```
...
result = contrast("Hello World")

# Example 2: Batch processing
from micro_color_contrast import batch
